...
fun ProductCarouselItem(
    ...
    val imageAngle: Float by animateFloatAsState(
        ...
        animationSpec = tween(durationMillis = 600, easing = Util.EaseOutQuart), label = ""
    )
    val offsetX: Float by animateFloatAsState(
        ...
        animationSpec = tween(durationMillis = 400, easing = Util.EaseOutQuart), label = ""
    )
    ...
    val offsetDetailsX: Float by animateFloatAsState(
        ...
        animationSpec = tween(durationMillis = 800, easing = Util.EaseOutQuart), label = ""
    )
